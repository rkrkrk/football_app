...
public class CustomListActivity extends ListActivity {
	...
	private void fillData() {
		...
		Uri allTitles = CustomContentProvider.CONTENT_URI;
		String[] from = new String[] { CustomContentProvider.TIME,
				CustomContentProvider.TEAM, CustomContentProvider.OUTCOME,
				CustomContentProvider.TYPE, "panel_nickname",CustomContentProvider.PLAYER_ID,
				CustomContentProvider.POSITION };
	...
	public boolean onContextItemSelected(MenuItem item) {
		...
		case R.id.menu_delete1:
			...
			AdapterContextMenuInfo info = (AdapterContextMenuInfo) item
					.getMenuInfo();
			Uri uri = Uri
					.parse(CustomContentProvider.CONTENT_URI + "/" + info.id);
